...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Funky!', 1], //From 90% to 99%
		['Super-funky!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	var dialogue:Array<String> = ['blah blah blah', 'coolswag', 'we do a little bit of trolling', 'what', 'lmao', 'sus'];
