...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Shadow Shaggy',			'shadowshaggy',		'Secondary Programmer of Vs. Foxa SE',					'https://www.youtube.com/channel/UCa5q_c9YrU_Duy6W4e3qhlw',		'C30085'],
			['FBI Agent',				'fbi',			'Charter of Vs. Foxa SE',				'https://gamejolt.com/@YourFellowIdiot',			'279ADC'],
			[''],
			['Vs. Foxa Story Edition External Assets'],
			['magnumsrtisswag',	    'face',	        'Stage Editor',		    'https://github.com/ShadowMario/FNF-PsychEngine/pull/3502',		                'A1A1A1'],
			['Psych Engine Team'],
