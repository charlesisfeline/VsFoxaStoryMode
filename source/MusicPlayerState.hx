...
//i took it from vdab but i'll wait for the devs to respond how to contact ben
...
class MusicPlayerState extends MusicBeatState
{
    ...
    {
        var initSonglist = ['internal,bubbles,foxa,good', 'internal,burning-flames,foxa-angy,good', 'internal,execution,foxa-mad,bad', 'internal,firestorm,foxa-mad,bad']; //ah yeah dj song list
		...
		iconP2 = new HealthIcon("foxa", false);
