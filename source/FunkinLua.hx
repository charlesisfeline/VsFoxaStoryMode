...
class FunkinLua
{
	...
	public function new(script:String)
	{
		...
		{
			lime.app.Application.current.window.alert(resultStr, '- There is a problem with the .LUA script. Go fix it, please.');
			trace('Error on .LUA script AAAAAAAAAAAAAAAAAA ' + resultStr);
			lua = null;
			return;
		}
		scriptName = script;
		...
		// not safe yet until someone smarter comes along and makes a safer version of the OS shit
		set('require', true);
		set('os', true);
